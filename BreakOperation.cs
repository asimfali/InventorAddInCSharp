...
namespace InvAddIn
{
    internal class MyBreakOperation : Button
    {
        ...
        #region "Methods"
        public MyBreakOperation(string displayName, string internalName, string clientId, string description, string tooltip, Icon standardIcon, Icon largeIcon)
    ...
    internal class MyBreakOperationVert : Button
    {
        ...
        #region "Methods"
        public MyBreakOperationVert(string displayName, string internalName, string clientId, string description, string tooltip, Icon standardIcon, Icon largeIcon)
            : base(displayName, internalName, clientId, description, tooltip, standardIcon, largeIcon)
        {
