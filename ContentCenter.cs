...
namespace InvAddIn
{
    internal class ContentBtn : Button
    {
        ...
        #region "Methods"
        public ContentBtn(string displayName, string internalName, CommandTypesEnum commandType, string clientId, string description, string tooltip, Icon standardIcon, Icon largeIcon, ButtonDisplayEnum buttonDisplayType)
